...
import { CoursService, CourseCreateData, CourseUpdateData } from '../../services/learning/CoursService';
import { RoleUtilisateur, UserData, IUser } from '../../types';
