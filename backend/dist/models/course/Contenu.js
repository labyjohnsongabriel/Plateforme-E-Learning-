...
contenuSchema.methods.visualiser = async function (utilisateurId) {
    ...
    await Progression.updateOne({ utilisateur: utilisateurId, cours: this.cours }, { $set: { dateDerniereActivite: new Date() }, $inc: { avancement: 5 } }, // Incrémente de 5% par visualisation
    { upsert: true });
