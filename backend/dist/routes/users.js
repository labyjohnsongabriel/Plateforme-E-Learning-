...
router.get("/domaine/:id/stats", authMiddleware, authorizationMiddleware([RoleUtilisateur.ADMIN]), async (req, res, next) => {
    try {
...
// Routes pour Cours
router.post("/", authMiddleware, authorizationMiddleware([RoleUtilisateur.ADMIN]), validationMiddleware(courseValidator.create), CoursController.create);
...
router.put("/:id", authMiddleware, authorizationMiddleware([RoleUtilisateur.ADMIN]), validationMiddleware(courseValidator.update), CoursController.update);
...
router.post("/quiz/:id/soumettre", authMiddleware, authorizationMiddleware([RoleUtilisateur.LEARNER]), QuizController.soumettre);
