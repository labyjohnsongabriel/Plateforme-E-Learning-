...
// Youth Computing Theme selon la charte graphique
const theme = createTheme({
  palette: {
    mode: 'light',
    primary: {
      main: '#010b40', // Bleu marine principal
      light: '#1a237e',
      dark: '#000051',
      contrastText: '#ffffff',
    },
  ...
  typography: {
    fontFamily: 'Ubuntu, "Century Gothic", "Roboto", "Helvetica", "Arial", sans-serif',
    h1: {
    ...
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          boxShadow: 'none',
          '&:hover': {
            boxShadow: '0 4px 8px rgba(1, 11, 64, 0.2)',
          },
        },
        containedPrimary: {
