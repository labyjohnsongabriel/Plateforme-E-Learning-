...
export const getByUserAndCourse = async (
  apprenantId: string | Types.ObjectId,
  coursId: string | Types.ObjectId
): Promise<IProgression> => {
  try {
...
export const getUserProgressions = async (apprenantId: string | Types.ObjectId): Promise<IProgression[]> => {
  try {
...
export const getAllProgressions = async (): Promise<IProgression[]> => {
  try {
